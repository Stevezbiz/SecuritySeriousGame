...
public class LVL1_MessageList : MonoBehaviour {
    ...
    List<LVL1_MessageRecord> messages = new List<LVL1_MessageRecord>();
    ...
    public void AddNewMessageButton() {
        ...
        LVL1_MessageToSend newMessageToSend = newMessage.GetComponent<LVL1_MessageToSend>();
    ...
    public void AddMessage(string sourceIP, string destIP, string sourceMAC, string destMAC, string body) {
        ...
        LVL1_MessageRecord messageRecord = newItem.GetComponent<LVL1_MessageRecord>();
