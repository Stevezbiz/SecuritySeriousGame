...
public class LVL2_SwitchTab : MonoBehaviour {
    ...
    void Start() {
        ...
        foreach (KeyValuePair<string, string> record in switchScript.GetCAMTable()) {
            ...
            LVL2_CAMRecord newRecord = newItem.GetComponent<LVL2_CAMRecord>();
    ...
    public void SetSwitch(LVL2_Switch value) {
        switchScript = value;
    }
}
