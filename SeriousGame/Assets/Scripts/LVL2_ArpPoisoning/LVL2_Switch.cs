...
public class LVL2_Switch : MonoBehaviour {
    ...
    public void ReceivedPacket(string port, LVL2_Packet receivedPacket) {
        // update CAM table
    ...
    public void SwitchClick() {
        ...
        LVL2_SwitchTab script = tab.GetComponent<LVL2_SwitchTab>();
        script.SetSwitch(gameObject.GetComponent<LVL2_Switch>());
    }
}
